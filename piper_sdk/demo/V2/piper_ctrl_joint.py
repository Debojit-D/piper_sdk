...
Behavior:
- Enables the Piper arm.
- Commands joint-space motion between:
    1. zero joint pose
    2. a non-zero joint pose
- Also commands the gripper together with the joint target.
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Print arm status and commanded target
